(function ($) {
    ...
    $('.scroll-to-section a[href^="#"]').on("click", function (e) {
      ...
      $("html, body")
        ...
        .animate(
          ...
          "swing",
          function () {
            // Increased duration to 700ms for smoother scroll
  ...
  $(window).on("load", function () {
    ...
    // AOS.refresh(); // Refresh AOS after images are loaded if needed, can be uncommented if animations are not triggering correctly on load
